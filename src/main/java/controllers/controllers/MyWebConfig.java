...
public class MyWebConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		// TODO Auto-generated method stub
		registry.addInterceptor(getInterceptor1());
	...
	public HandlerExceptionResolver getExceptionResolver()
	{
		...
		exceptionMapping.setProperty(Exception1.class.getName(),"errorVijay");
		SimpleMappingExceptionResolver exceptionResolver = new SimpleMappingExceptionResolver();
		exceptionResolver.setExceptionMappings(exceptionMapping);
		exceptionResolver.setDefaultErrorView("errorVijay");
